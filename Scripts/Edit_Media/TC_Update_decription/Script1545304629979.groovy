...
WebUI.clearText(findTestObject('Edit_Media/Edit_media_fields/description'))

WebUI.setText(findTestObject('Edit_Media/Edit_media_fields/description'),descriptionText)

cdescription=WebUI.getAttribute(findTestObject('Edit_Media/Edit_media_fields/description'), 'value')
...
udescription=WebUI.getAttribute(findTestObject('Edit_Media/Edit_media_fields/description'), 'value')
